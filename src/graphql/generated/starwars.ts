...
const defaultOptions = {"context":{"clientName":"StarWars"}} as const;
...
export type GetAllPlanetsQuery = { __typename?: 'Root', allPlanets?: { __typename?: 'PlanetsConnection', planets?: Array<{ __typename?: 'Planet', name?: string | null, gravity?: string | null, population?: number | null } | null> | null } | null };
 ...
 * });
 */
export function useGetAllPlanetsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetAllPlanetsQuery, GetAllPlanetsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetAllPlanetsQuery, GetAllPlanetsQueryVariables>(GetAllPlanetsDocument, options);
      }
export function useGetAllPlanetsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetAllPlanetsQuery, GetAllPlanetsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetAllPlanetsQuery, GetAllPlanetsQueryVariables>(GetAllPlanetsDocument, options);
        }
